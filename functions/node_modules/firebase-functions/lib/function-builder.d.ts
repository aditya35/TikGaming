...
export declare class FunctionBuilder {
    ...
    readonly https: {
        ...
        * @param handler A function that takes a request and response object,
         ...
         */
        // onRequest: (handler: (req: express.Request, resp: express.Response) => void) => import("./cloud-functions").HttpsFunction;
        /**
         * Declares a callable method for clients to call using a Firebase SDK.
         * @param handler A method that takes a data and context and returns a value.
         */
        onCall: (handler: (data: any, context: https.CallableContext) => any) => TriggerAnnotated & ((req: express.Request, resp: express.Response) => void) & Runnable<any>;
    };
    readonly database: {
        /**
